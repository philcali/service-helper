...
public class PolicyTest {
    ...
    public void testRequiredMethodParams() {
        ...
        IPolicy policy = Policy.builder()
                .withPrincipalId("abc-123")
                .withMethodArn(methodArn)
                .allowAllMethods()
                .withContext("name", "Philip Cali")
                .build();
    ...
    public void testEquals() {
        ...
        IPolicy policy = Policy.builder()
                ...
                .allowAllMethods()
                .build();
        IPolicy other = Policy.builder()
                .withPrincipalId("abc-123")
                .withRegion("us-east-1")
                .withAccountId("abc123")
                .withGatewayId("example")
                .withStage("prod")
                .allowAllMethods()
                .build();
